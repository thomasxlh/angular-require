...
gulp.task('uglify', function () {
    var stream = gulp.src(['./dist/artifacts/ptp-confirmation.js'])
...
gulp.task('less', function () {
    ...
    var stream = gulp.src(['./src/styles/ptp-confirmation.less'])
        .pipe(less({
...
gulp.task('minifycss', function () {
    var stream = gulp.src(['./dist/artifacts/ptp-confirmation.css'])
        .pipe(rename({suffix: '.min'}))
        .on('error', gulpConfigs.errorHandle)
        .pipe(minifycss())
        .on('error', gulpConfigs.errorHandle)
...
gulp.task('karma-test', ['local-cdn'], function (done) {
    new Server({
        ...
        preprocessors: {
            'ser/ptp-confirmation/**/*.js': 'coverage'
        },
        coverageReporter: {
...
gulp.task('watch:html', function () {
    gulp.watch('src/ptp-confirmation/**/*.html', function (event) {
